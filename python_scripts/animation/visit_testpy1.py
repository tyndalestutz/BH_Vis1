...
import visit
visit.Launch()
import visit # for some reason this works in cli but not in .py
v = visit

visit.OpenDatabase("localhost:/home/guest/Documents/VisIt/tutorial1/sphere_50pts.obj", 0)
visit.AddPlot("Mesh", "OBJMesh", 1, 1)
visit.DrawPlots()
...
View3DAtts.parallelScale = 14.4568
View3DAtts.nearPlane = -28.9137
View3DAtts.farPlane = 28.9137
