# I did this locally on my windows desktop so path names will need to be changed

import sys, csv, os
sys.path.append(r"C:\Users\sethw\LLNL\VisIt3.3.2\lib\site-packages") 
import visit
visit.Launch()
import visit
v = visit
...
###File names
database = r"C:\Users\sethw\OneDrive\Documents\BHVisualization\BH_Vis-main\database\mesh\iscos_halfr_sphere_sub8.obj"
bh_data = r"C:\Users\sethw\OneDrive\Documents\BHVisualization\BH_Vis-main\database\synthetic_coords\synthetic_data_ang_momentum.csv"
...
#background_image = "../BH_Vis-main/database/background_images/blue_grid.png"
...
def default_atts():
    ...
    # top down camera view, position for inset
    #View3DAtts.viewNormal = (0, 0, 1)
    #View3DAtts.viewUp = (0, 1, 0)

    # angled view 
    View3DAtts.viewNormal = (1, 0, 0.1)
    View3DAtts.viewUp = (-0.1, 0.25, 1)
    ...
    # -------- Changed window save atts.
    s = v.SaveWindowAttributes()
    s.outputToCurrentDirectory = 0
    s.outputDirectory = r"C:\Users\sethw\OneDrive\Documents\BHVisualization\local\renders\testMovieWithInset"
    s.fileName = "renderInsetTest"
    s.format = s.PNG
    s.progressive = 1
    s.width = 772
    s.height = 702
...
# create image/inset, global scope since it changes
image = v.CreateAnnotationObject("Image")
image.image = r"C:\Users\sethw\OneDrive\Documents\BHVisualization\local\renders\insetTest\synthetic_BH_test_animation0000.png"
image.position = (0, 0)
image.width = 40
image.height = 40
...
# use os module to store inset png's in a list - only stores file name, NOT the whole directory
inset_images = os.listdir(r"C:\Users\sethw\OneDrive\Documents\BHVisualization\local\renders\insetTest")
...
with open(bh_data, 'r') as file:
    ...
    for row in reader:
        ...
        # update image inset shown
        current_inset = inset_images[inset_index]
        image.image = "..\\renders\\insetTest\\" + current_inset
        inset_index += 1
...
#ffmpeg -framerate 1000 -i renderInsetTest%04d.png -vf "scale=770:-2" -c:v libx264 -r 1000 -pix_fmt yuv420p output.mp4
